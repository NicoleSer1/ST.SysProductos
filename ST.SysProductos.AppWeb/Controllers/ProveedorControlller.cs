...
using ST.SysProductos.BL;
using ST.SysProductos.EN;

namespace ST.SysProductos.AppWeb.Controllers
{
    public class ProveedorController : Controller
    {
        ...
        // GET: ProveedorControlller
        public async Task<ActionResult> Index()
        {
            var proveedores = await _proveedorBL.ObtenerTodosAsync();
            return View(proveedores);
        }
        // GET: ProveedorControlller/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: ProveedorControlller/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ProveedorControlller/Create
        [HttpPost]
        ...
        // GET: ProveedorControlller/Edit/5
        ...
        // POST: ProveedorControlller/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ProveedorControlller/Delete/5
        ...
        // POST: ProveedorControlller/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
